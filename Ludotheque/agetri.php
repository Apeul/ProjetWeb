    ...
    <div id="contenu">
      ...
      <?php
        ...
        if($_SESSION['age']!=0)
        {
            if($_SESSION['age']==3)
            {
               $requete='SELECT nom_jeux, genre1, genre2, age_min, prix, image, date_parution, description FROM `jeux` WHERE age_min>=3 ORDER BY age_min ASC';
            }
            else if($_SESSION['age']==7)
            {
               $requete='SELECT nom_jeux, genre1, genre2, age_min, prix, image, date_parution, description FROM `jeux` WHERE age_min>=7 ORDER BY age_min ASC';
            }
            else if($_SESSION['age']==12)
            {
               $requete='SELECT nom_jeux, genre1, genre2, age_min, prix, image, date_parution, description FROM `jeux` WHERE age_min>=12 ORDER BY age_min ASC';
            }
            else if($_SESSION['age']==18)
            {
               $requete='SELECT nom_jeux, genre1, genre2, age_min, prix, image, date_parution, description FROM `jeux` WHERE age_min>=18 ORDER BY age_min ASC';
            }
